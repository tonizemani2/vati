# One-Click Runbook - The World After AI: intelligence gets permission to act
...
```bash
python3 ~/.codex/skills/pope-mega/scripts/pope_board.py research/pope/post-ai-world-2026-06-17.json --emit-dir research/pope/post-ai-world-2026-06-17.formats
```

## Render The Research Note

```bash
python3 -m engine.pope.render research/pope/post-ai-world-2026-06-17.json research/pope/post-ai-world-2026-06-17
```

## Open The Operator Console

```bash
open research/pope/post-ai-world-2026-06-17.formats/operator_console.html
```
